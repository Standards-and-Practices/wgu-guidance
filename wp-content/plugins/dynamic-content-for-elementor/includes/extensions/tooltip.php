...
class Tooltip extends \DynamicContentForElementor\Extensions\ExtensionPrototype
{
    ...
    private function add_controls($element, $args)
    {
        ...
        $element->add_group_control(Group_Control_Typography::get_type(), ['name' => 'dce_tooltip_typography', 'label' => __('Typography', 'dynamic-content-for-elementor'), 'selector' => ".tippy-box[data-theme~='theme_{{ID}}']"]);
        ...
        $element->add_control('dce_tooltip_border_radius', ['label' => __('Border Radius', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px', '%'], 'selectors' => [".tippy-box[data-theme~='theme_{{ID}}']" => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;']]);
