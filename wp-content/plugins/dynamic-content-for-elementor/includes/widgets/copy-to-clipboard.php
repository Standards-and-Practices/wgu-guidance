...
class CopyToClipboard extends \DynamicContentForElementor\Widgets\WidgetPrototype
{
    ...
    protected function safe_register_controls()
    {
        ...
        $this->add_control('dce_clipboard_btn_position', ['label' => __('Button Position', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::CHOOSE, 'default' => 'static', 'options' => ['static' => ['title' => __('Static', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-square'], 'absolute' => ['title' => __('Absolute', 'dynamic-content-for-elementor'), 'icon' => 'fa fa-square-o']], 'toggle' => \false, 'selectors' => ['{{WRAPPER}} .elementor-button' => 'position: {{VALUE}};'], 'render_type' => 'template']);
